...
| --- | --- | --- | --- |
| O1 | 2.1.0 | Current | Curated universe, persistent watchlist and periodic multi-symbol scans |
| O2 | 2.2.0 | Next | Provider-backed symbol search, metadata and richer watchlist UX |
